    ...
    <div id="popup" className={`popup popup_type_profile ${props.isOpen && 'popup_visible'}`}>
      ...
      <div className="popup__window">
        ...
        <form id="profile-form" name="profile" className="popup__form">
          <input onChange={handleNameChange} value={name||''} name="first" id="profile-name" placeholder="Имя" type="text" className=" popup__input popup__first-input popup__name-input" required minLength={2} maxLength={40} noValidate   />
          <span id="profile-name-error" className="popup__error-message" />
          <input onChange={handleDescriptionChange} value={description||''} name="second" id="profile-information" placeholder="Информация" type="text" className=" popup__input popup__second-input popup__info-input" required minLength={2} maxLength={200} noValidate   />
