  ...
  return (
    <div id="popup" className={`popup popup_type_changeavatar ${props.isOpen && 'popup_visible'}`}>
      ...
      <div className="popup__window">
        ...
        <input ref={imputRef} name="second" id="profile-avatar" placeholder="Ссылка" type="url" className=" popup__input popup__second-input popup__avatar-link" required noValidate />
          <span id="profile-avatar-error" className="popup__error-message" />
          <button onClick={handleSubmit} type="submit" className="popup__save-button popup__save-button_disabled button">
            Сохранить
        </button>
        </form>
      </div>
